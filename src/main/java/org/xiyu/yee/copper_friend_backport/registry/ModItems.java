...
import org.xiyu.yee.copper_friend_backport.copper_chest.CopperChestBlockItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> COPPER_CHEST = ITEMS.register(
            "copper_chest",
            () -> new CopperChestBlockItem(ModBlocks.COPPER_CHEST.get(), new Item.Properties())
    );

    public static final RegistryObject<Item> EXPOSED_COPPER_CHEST = ITEMS.register(
            "exposed_copper_chest",
            () -> new CopperChestBlockItem(ModBlocks.EXPOSED_COPPER_CHEST.get(), new Item.Properties())
    );

    public static final RegistryObject<Item> WEATHERED_COPPER_CHEST = ITEMS.register(
            "weathered_copper_chest",
            () -> new CopperChestBlockItem(ModBlocks.WEATHERED_COPPER_CHEST.get(), new Item.Properties())
    );

    public static final RegistryObject<Item> OXIDIZED_COPPER_CHEST = ITEMS.register(
            "oxidized_copper_chest",
            () -> new CopperChestBlockItem(ModBlocks.OXIDIZED_COPPER_CHEST.get(), new Item.Properties())
    );

    // Copper Chest Block Items - Waxed variants
    public static final RegistryObject<Item> WAXED_COPPER_CHEST = ITEMS.register(
            "waxed_copper_chest",
            () -> new CopperChestBlockItem(ModBlocks.WAXED_COPPER_CHEST.get(), new Item.Properties())
    );

    public static final RegistryObject<Item> WAXED_EXPOSED_COPPER_CHEST = ITEMS.register(
            "waxed_exposed_copper_chest",
            () -> new CopperChestBlockItem(ModBlocks.WAXED_EXPOSED_COPPER_CHEST.get(), new Item.Properties())
    );

    public static final RegistryObject<Item> WAXED_WEATHERED_COPPER_CHEST = ITEMS.register(
            "waxed_weathered_copper_chest",
            () -> new CopperChestBlockItem(ModBlocks.WAXED_WEATHERED_COPPER_CHEST.get(), new Item.Properties())
    );

    public static final RegistryObject<Item> WAXED_OXIDIZED_COPPER_CHEST = ITEMS.register(
            "waxed_oxidized_copper_chest",
            () -> new CopperChestBlockItem(ModBlocks.WAXED_OXIDIZED_COPPER_CHEST.get(), new Item.Properties())
    );

    // Copper Golem Statue Block Items - COMMENTED OUT
    /*
